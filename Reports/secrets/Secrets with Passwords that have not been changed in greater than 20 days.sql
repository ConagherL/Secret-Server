SELECT a.DateRecorded AS 'Last Password Change Date'
, a.Action as 'Action'
,a.SecretId,
...
WHERE a.Action = 'CHANGE PASSWORD' and cast(CONVERT(datetime, a.DateRecorded)as date) < (GetDate() - 20) AND s.Active = 1
